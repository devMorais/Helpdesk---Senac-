...
<?php
  ...
  $sts = new funcoessql();
  $sts->setconsulta("select id_status, desc_status from status");
  
  // buscando informações do banco helpdesk 
  if($sts->total() > 0)
 {
	  
	  foreach($sts->ler() as $s)
	  {
		...
		<tr>
		  ...
		  data-whatever='$s[0]' 
		  data-whatevermsg='$s[1]'>Alterar</button></td>
		  ...
		  data-whatever='$s[0]'
		  data-whatevermsg='$s[1]'>Excluir</button></td>
...
<div class="modal fade" id="modalAlterar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
	...
	<form method=post action=funcoes_status.php>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">ID Categoria</label>
            <input type="text" class="form-control" name=idsts id="recipient-name" readonly>
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label"> Descrição:</label>
            <textarea class="form-control" name=descsts id="message-text" required></textarea>
          </div>
	  ...
	  <div class="modal-footer">
        ...
        <button type="submit" name=altsts class="btn btn-primary">Alterar</button>
...
<div class="modal fade" id="modalExcluir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
	...
	<form method=post action=funcoes_status.php>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">ID Status</label>
            <input type="text" class="form-control" name=idsts id="recipient-name" readonly>
          </div>
	  ...
	  <div class="modal-footer">
        ...
        <button type="submit" name=excsts class="btn btn-primary">Excluir</button>
...
<div class="modal fade" id="modalInserir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
	...
	<form method=post action=funcoes_status.php>
		  ...
		  <div class="form-group">
            <label for="recipient-name" class="col-form-label">Descrição Status</label>
            <input type="text" class="form-control" name=descsts required>
          </div>
	  ...
	  <div class="modal-footer">
		...
		<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
        <button type="submit" name=inssts class="btn btn-primary">Inserir</button>
